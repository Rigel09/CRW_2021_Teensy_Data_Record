#******************************************************************************
# Generated by VisualTeensy V1.4.0 on 10/31/2021 at 10:42 PM
#
# Board              Teensy 4.1
# USB Type           Serial
# CPU Speed          600 MHz
...
TARGET_NAME      := CRW_2021_Teensy_Data_Record
BOARD_ID         := TEENSY41

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\Newton\Documents\Arduino\libraries
LIBS_SHARED      := 
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=155 -DARDUINO_TEENSY41 -DARDUINO=10813
